  ...
  return (
    <>
      <Section className="contact-us contact_main">
        <Helmet>
          <title>Suraj Industrial</title>
          <meta name="description" content="About Us | Suraj Industrial" />
        </Helmet>
        <div className="container-fluid">
          <div className="row row-margin-bottom">
            <div className="col-md-6">
              ...
              <p>
                <b>Suraj Industrial,</b>
                <br />
                Plot no. 19, Survey 36 Near Paras Industries, <br />
                Near Paras Industries Falcon Road, <br />
                Vavdi Industrial Area Vavdi Rajkot 360004
                <br />
              </p>
              <ul>
                <li>
                  <p style={{ color: "black", fontWeight: "700" }}>
                    Email: &nbsp;
                    <a
                      href="mailto: surajindustries11@gmail.com"
              ...
              <div className="contact-form">
                ...
                <div className="input-row">
                  <Link
                    ...
                    onClick={() => mContactus()}
                    className="btn contact_btn_main"
                  >
                    SUBMIT CONTACT
                  </Link>
                </div>
