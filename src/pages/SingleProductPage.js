...
const SingleProductPage = () => {
  ...
  console.log("wishprodid --->", wishprodid);
  // window.scrollTo(0, 0);
  ...
  useEffect(() => {
    fetchSingleProduct(`${url}/${slug}/abc/${userid}`);
  }, [slug]);
      ...
      >
        ...
        <div className="product-center">
          ...
          <section className="content">
            ...
            <h3 className="sing-prod-heading">Coffee Mug</h3>
            {/* ratings */}
            ...
            <div className="description-part-main">
              <div className="description-part">
                <p className="info_last">
                  <b>Description : </b>
                  <p>
                    Blue & Purple Insulated Stainless Steel Coffee Mug,
                    Packaging Type: Box, 300ml
                  </p>
                  {/* <p
            ...
            <div className="userinfo">
              ...
              <ul>
                ...
                >
                  ...
                  <p>Call or WhatsApp us at +91 98984 00911</p>
                </li>
                <li
                  style={{
                    display: "flex",
                ...
                >
                  ...
                  <p>E-mail us at surajindustries11@gmail.com</p>
                </li>
              </ul>
            </div>
            <hr />
...
const Wrapper = styled.main`
  ...
  .active {
    box-shadow: 0px 0px 0px 2px var(--clr-grey-1);
  }
